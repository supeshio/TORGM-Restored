    ...
    public class ModUpdater { 
        ...
        public static async Task<bool> checkForUpdate() {
            try {
                ...
                var response = await http.GetAsync(new System.Uri("https://api.github.com/repos/supeshio/TORGM-Restored/releases/latest"), HttpCompletionOption.ResponseContentRead);
